    ...
    return (
        <>
            <div className="w-full h-130 relative">
                <img src="products-banner-2.jpg.jpeg" alt="" className="absolute w-full h-full object-cover" />
                <div className="absolute flex justify-end   w-full h-full items-center flex-col p-5">
                    <h2 className="text-xl font-bold text-white mb-5">Produits vedettes</h2>
                    <div className="carousel col-span-2 border-amber-400 carousel-center w-full   bg-base-200 rounded-box ">
